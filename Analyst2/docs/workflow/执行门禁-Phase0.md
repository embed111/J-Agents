...
- 证据:
  - 命令: `python scripts/run_phase0_gate_acceptance.py --root . --host 127.0.0.1 --port 8098`
  - `logs/runs/gate-phase0-acceptance-20260225-101322.md`（`five_session_parallel`、`send_interrupt_retry`）
  - `scripts/day3_web_app.js`
  - `scripts/day3_web_chat.py`
...
- 证据:
  ...
  - `scripts/day3_web_chat.py`（`AB_FEATURE_ENABLED` 默认关闭）
