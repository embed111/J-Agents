...
def ensure_tables(
    ...
    *,
    ...
    try:
        ...
        conn.execute(
            "CREATE TABLE IF NOT EXISTS training_queue (queue_task_id TEXT PRIMARY KEY,plan_id TEXT NOT NULL,priority TEXT NOT NULL,status TEXT NOT NULL DEFAULT 'queued',trainer_match TEXT NOT NULL DEFAULT '',enqueued_at TEXT NOT NULL,started_at TEXT NOT NULL DEFAULT '',finished_at TEXT NOT NULL DEFAULT '')"
        )
        conn.execute(
